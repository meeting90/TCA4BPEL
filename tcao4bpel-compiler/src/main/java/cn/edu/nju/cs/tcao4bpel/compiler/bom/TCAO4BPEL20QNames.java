 ...
 * 2015-1-7 2015
 * TCAO4BPEL20QNames.java
 */
public class TCAO4BPEL20QNames {
	public static final String NS_TCAO4BPEL2_0_ASPECT="http://cs.nju.edu.cn/tcao4bpel/2.0/aspect";
	...
	private static QName newFinalQName(String localname){
		return new QName(NS_TCAO4BPEL2_0_ASPECT, localname);
	}
